			...
			<c:forEach var="i" begin="0" end='${fn:length(valeur)-1}'>
				<div class="line">
				  ...
				  <div class="form-group">
					...
					<div class="form-group">
						<div style="display:none" class="alert warning alert-warning cascade-warning warning_modify" ></div>
					</div>
					<div class="form-group">
		        ...
		        <h4 class="modal-title">Ajouter une value</h4>
					      ...
					      <div class="modal-body">
									<form>
										...
										<div style="display:none" class="warning alert-warning cascade-warning warningadd">
										</div>
